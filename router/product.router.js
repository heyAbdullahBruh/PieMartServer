...
const { createProduct,createRating,updateProduct,getAllProduct,getPriceProduct,getCataProduct, getBrandProduct,getRatProduct,deleteProduct, getSingleProduct, getAdminProduct, getAllItemProduct } = require('../controller/product.controll');
...
router.get('/product/:lowP/:highP/:lowR/:highR/',getAllItemProduct);
